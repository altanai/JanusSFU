# Janus as SFU for mid sized WebRTC conferences 
...
![alt webrtc development janus_publisher_videoRoom](janus_callflow1.jpg)

When another publisher join the room and subscribes to existing streams
